  ...
  return (
    ...
    >
      ...
      <div className="section-container relative z-10 flex flex-col items-center pt-32 pb-16">
        ...
        {/* Name + Title */}
        <div className="animate-in opacity-0 stagger-2 max-w-4xl space-y-8">
          <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-text leading-none">
            M Naveen
          </h1>
          <h2 className="text-xl md:text-2xl font-medium text-text-dim leading-snug mx-auto max-w-2xl">
            Backend Developer specializing in <span className="text-text font-bold">microservices</span> and <span className="text-text font-bold">scalable systems</span>.
          </h2>
        </div>

        {/* Highlight Tagline */}
        <div className="animate-in opacity-0 stagger-3 mt-12 mb-14">
          <p className="text-base text-muted max-w-2xl mx-auto leading-relaxed font-mono">
